document.addEventListener('DOMContentLoaded', () => {
    ...
    // Функция для предпросмотра темы (была applyCustomTheme)
    ...
    if (accentInput && bgInput && containerInput) {
        ...
        bgInput.addEventListener("input", previewTheme);
        containerInput.addEventListener("input", previewTheme);
    }
